...
import { AdminCommand, CreatePolicyClassCmd, CreateUserAttributeCmd, CreateObjectAttributeCmd, CreateUserCmd, CreateObjectCmd, DeleteNodeCmd, AssignCmd, DeassignCmd, AssociateCmd, DissociateCmd, ExecutePMLCmd, GenericAdminCmd, CreateProhibitionCmd, DeleteProhibitionCmd, DeleteObligationCmd } from '@/generated/grpc/v1/cmd';
...
export namespace AdjudicationService {
  ...
  export async function deleteProhibition(name: string): Promise<PdpAdjudication.AdminCmdResponse> {
  ...
  export async function deleteObligation(name: string): Promise<PdpAdjudication.AdminCmdResponse> {
